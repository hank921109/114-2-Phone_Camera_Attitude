...
| 指標名稱 | 誤差數值 | 說明 |
| :--- | :--- | :--- |
| **ATE (Absolute Trajectory Error)** | 0.3133 m | 全局軌跡絕對 RMSE 誤差 |
| **RPE (Relative Pose Error)** | 0.0717 m/frame | 相鄰幀相對平移漂移 |
| **Rotational RPE** | 0.0339 deg/frame | 相鄰幀相對旋轉角度漂移 |
| **MAE (Mean Absolute Error)** | 0.2110 m | 全局平均絕對距離誤差 |
| **Rotational MAE** | 0.3003 deg | 全局平均絕對旋轉角度誤差 |
| **Average Pipeline FPS** | 10.33 FPS | 整合所有管線的平均運行影格率 |
